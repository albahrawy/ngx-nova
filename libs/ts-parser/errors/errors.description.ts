...
type NodeTypesWithDescriptions = keyof Omit<typeof NodeDescriptions, "UpdateExpression">;

type NodeWithDescription = { type: "UpdateExpression"; prefix: boolean; } | { type: NodeTypesWithDescriptions; };
