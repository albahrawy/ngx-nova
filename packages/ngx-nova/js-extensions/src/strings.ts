...
export namespace strings {
    ...
    */
    export function formatBy(value: string, obj: any): string {
        return value?.replace(formatByRegx, (_, key) => objects.get(obj, key, ''));
    }
    ...
    */
    export function trimHead(value: string, ...chars: string[]): string {
