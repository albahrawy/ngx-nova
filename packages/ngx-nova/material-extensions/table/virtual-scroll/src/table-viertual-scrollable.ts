...
import { CdkScrollable, CdkVirtualScrollable, CdkVirtualScrollableElement, CdkVirtualScrollViewport, ExtendedScrollToOptions, ScrollDispatcher, ViewportRuler, VIRTUAL_SCROLL_STRATEGY, VIRTUAL_SCROLLABLE, VirtualScrollStrategy } from '@angular/cdk/scrolling';
    ...
    providers: [
        { provide: CdkVirtualScrollViewport, useExisting: CdkTableVirtualScrollable },
        {
            ...
            useFactory: (
                ...
                viewport: CdkTableVirtualScrollable<any>,
            ) => virtualScrollable || viewport,
            deps: [[new Optional(), new Inject(VIRTUAL_SCROLLABLE)], CdkTableVirtualScrollable],
        },
    ],
})
export class CdkTableVirtualScrollable<T> extends CdkVirtualScrollable implements OnInit, OnDestroy {
    ...
    protected readonly sizeChangedStream = this.viewportRuler.change();
    ...
    constructor(
        ...
        @Self() @Inject(CDK_TABLE) _cdkTable: CdkTable<any>,
        ...
        super(createWrapper(elementRef, renderer, _cdkTable), scrollDispatcher, ngZone, dir);
...
function createWrapper(elementRef: ElementRef<HTMLElement>, renderer: Renderer2, table: CdkTable<any>): VirtualWrapperElementRef {
